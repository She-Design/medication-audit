...
| 🖥️ | **[research site](https://medication-audit.vercel.app)** | The research as a single clean page for stakeholders — product, competitors, benchmark, patterns, conclusions, with tables and screens inline. Source: [research.html](./research/research.html); redeploy with `./research/deploy.sh` | 🟢 Live |
